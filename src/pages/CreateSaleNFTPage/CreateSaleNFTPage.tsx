...
import { BlueButton, BlueButtonWithCollab, GrayBtnWide } from '../../components/Buttons/Buttons';
...
import { ButtonsWrapper, BuyNFTImage, BuyNFTPageWrapper, CancelSellBtn, CollabBtn, CrossedMediumText, InfoContainer, InfoContainerTitle, InfoPointSubtitle, InfoPointTitle, InfoPointWrapper, PriceContainer, PriceMediumText, PriceWrapper, TextInDollars } from './CreateSaleNFTPageStyles';
import DaoLogo from "../../assets/pictures/daolamaLogo.png";
...
const CreateSaleNFTPage = ({} : CreateSaleNFTPageProps) => {  
    ...
    const onCollabBtnClick = (address: string) => {
        // open link with href
        const initLink = `https://daolama.co`;
        // https://daolama.co/pawn/nft/${address}
    ...
    return (
        <MyNFTSPageContainer>
            ...
            <BuyNFTPageWrapper>
                ...
                <ButtonsWrapper>
                    <BlueButtonWithCollab disabled={nft.sale ? true : false} onClick={() => setModalIsOpen(true)}>{!nft.sale ? t("createSalePage.putOnSaleBtn") : t("createSalePage.alredyOnSaleBtn")}</BlueButtonWithCollab>
                    <CollabBtn
                        onClick={() => onCollabBtnClick(nftAddress)}
                        src={DaoLogo}
                    />
                </ButtonsWrapper>
