...
import { MyStyledInputSearch, SearchIcon, SearchWrapper } from '../../components/Modal/PutOnSaleNFTModal/PutOnSaleNFTModalStyles';
...
const MyNFTSPage = ({} : MyNFTSPageProps) => {   
    ...
    const filteredItems = items.filter((item: any) => {
        ...
        return nftName.includes(watch("search").toLocaleLowerCase())
    });
