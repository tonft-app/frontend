...
import { BasePageContainer, BasePageSubtitle, BasePageSubtitleTwo, BasePageTitle, BottomPanelLink, BottomPanelText, GradientBackground, ItemsWrapper, ItemsWrapperHorizontal, NavText, NavTextsWrapper, UnderHeaderInfoWrapper } from './BasePageStyles';
// @ts-ignore
